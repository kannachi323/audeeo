...
function(setup_assets target_name)
    ...
    file(GLOB VERTEX_SHADERS ${CMAKE_SOURCE_DIR}/src/gui/*.vs)
    file(GLOB FRAGMENT_SHADERS ${CMAKE_SOURCE_DIR}/src/gui/*.fs)
    
    add_custom_command(
        TARGET ${target_name} POST_BUILD
        COMMAND ${CMAKE_COMMAND} -E copy_if_different ${VERTEX_SHADERS} ${RES_DEST}
        COMMAND ${CMAKE_COMMAND} -E copy_if_different ${FRAGMENT_SHADERS} ${RES_DEST}
